import 'package:sokyo/src/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= SokyoBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= SokyoBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= SokyoBreakpoints.large) {
