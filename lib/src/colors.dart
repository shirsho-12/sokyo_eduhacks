...
/// Defines the color palette for the Sokyo UI.
abstract class SokyoColors {
  /// Black
  ...
  static const Color p2 = Color(0xfff4f1de);

  static const Color bar = Color(0xff3d405b);

  static const Color button = Color(0xff81b29a);

  static const Color primary = Color(0xfff2cc8f);
}
